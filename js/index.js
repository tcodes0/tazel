...
const english_About = () => {
  ...
  const changeToEnglish = () => {
    ...
    dev_li[3].querySelector('span').textContent = "I know all but prefer Mac or Linux."
    dev_li[4].querySelector('span').textContent = "I write scripts to automate things. I plan to pick up a more powerful language like Python or Ruby."
