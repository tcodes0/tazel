  ...
  >
    <div className="project-background" role="presentation">
      ...
      <div className="project-text">
        <p>
          The installation is made of a dark room with 4 speakers, each with a
          LED and a light sensor.
        </p>
        <ImgContained src={led} alt="Instalation LED in darkness" />
        <p>
          The room is always dark, but some lights can be seen, and music heard.
        </p>
        ...
        <p>
          Nununu came about from my desire to work with something experimental
          using technology and music related for my senior college project. I
          used Pure Data for the software that played music and coordinated
